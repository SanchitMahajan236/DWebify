...
export default function Home() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Automatic deployments with instant preview links and version control.",
    },
    {
      icon: Cpu,
    ...
    <ThemeProvider attribute="class" defaultTheme="dark" enableSystem>
      <div className="min-h-screen p-8 pb-20 gap-16 sm:p-12 font-[family-name:var(--font-geist-sans)] bg-background text-foreground">
        <header className="mb-12 text-center">
          ...
          Host your classic web projects, like calculators and unit converters, on the blockchain—absolutely free! Enjoy zero hosting fees and permanent availability. Preserve your simple web apps forever with Dwebify's decentralized hosting.
          </p>
          <Link href={"/dashboard"}>
